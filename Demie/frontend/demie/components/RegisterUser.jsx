...
const RegisterUser = ({ onBack }) => {
    ...
    const translateError = (message) => {
        ...
        // Backend may return raw codes like ACCOUNT_PENDING_ADMIN_APPROVAL
        if (message.includes('ACCOUNT_PENDING_ADMIN_APPROVAL')) {
            return 'Your account is pending administrator approval. An admin must activate your access before you can sign in.';
        }
        return message;
    };
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            setStatus({ type: 'error', msg: translateError(err.message) });
        }
    };
